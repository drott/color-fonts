...
|-|-|-|-|-|-|
| 0 | 󾀀 | U+FE000 | `.notdef` | None | None |
| 1 | 󾀁 | U+FE001 | `.null` | None | None |
| 2 | 󾀂 | U+FE002 | `upem_box_glyph` | None | None |
| 3 | 󾀃 | U+FE003 | `cross_glyph` | None | None |
| 4 | 󾀄 | U+FE004 | `one` | None | None |
| 5 | 󾀅 | U+FE005 | `zero` | None | None |
| 6 | 󰄀 | U+F0100 | `linear_repeat_0_1` | Tests `PaintLinearGradient` repeat modes for color stops 0, 1. | None |
| 7 | 󰄁 | U+F0101 | `linear_repeat_0.2_0.8` | Tests `PaintLinearGradient` repeat modes for color stops 0.2, 0.8. | None |
| 8 | 󰄂 | U+F0102 | `linear_repeat_0_1.5` | Tests `PaintLinearGradient` repeat modes for color stops 0, 1.5. | None |
| 9 | 󰄃 | U+F0103 | `linear_repeat_0.5_1.5` | Tests `PaintLinearGradient` repeat modes for color stops 0.5, 1.5. | None |
| 10 | 󰈀 | U+F0200 | `sweep_0_360_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 11 | 󰈁 | U+F0201 | `sweep_60_300_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 12 | 󰈂 | U+F0202 | `sweep_0_90_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 13 | 󰈃 | U+F0203 | `sweep_90_0_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 14 | 󰈄 | U+F0204 | `sweep_45_90_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 15 | 󰈅 | U+F0205 | `sweep_90_45_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 16 | 󰈆 | U+F0206 | `sweep_247.5_292.5_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 17 | 󰈇 | U+F0207 | `sweep_-45_45_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 18 | 󰈈 | U+F0208 | `sweep_45_-45_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 19 | 󰈉 | U+F0209 | `sweep_270_440_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 20 | 󰈊 | U+F020A | `sweep_440_270_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 21 | 󰈋 | U+F020B | `sweep_-180_540_pad_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 22 | 󰈌 | U+F020C | `sweep_0_360_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 23 | 󰈍 | U+F020D | `sweep_60_300_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 24 | 󰈎 | U+F020E | `sweep_0_90_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 25 | 󰈏 | U+F020F | `sweep_90_0_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 26 | 󰈐 | U+F0210 | `sweep_45_90_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 27 | 󰈑 | U+F0211 | `sweep_90_45_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 28 | 󰈒 | U+F0212 | `sweep_247.5_292.5_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 29 | 󰈓 | U+F0213 | `sweep_-45_45_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 30 | 󰈔 | U+F0214 | `sweep_45_-45_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 31 | 󰈕 | U+F0215 | `sweep_270_440_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 32 | 󰈖 | U+F0216 | `sweep_440_270_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 33 | 󰈗 | U+F0217 | `sweep_-180_540_reflect_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 34 | 󰈘 | U+F0218 | `sweep_0_360_repeat_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
| 35 | 󰈙 | U+F0219 | `sweep_60_300_repeat_narrow` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
...
| 66 | 󰈸 | U+F0238 | `sweep_45_-45_reflect_wide` | Tests `Paint(Var)SweepGradient`. | `SWPS` shifts sweep start angle, `SWPE` shifts sweep end angle, `SWC1`-`SWC4` shift color stop positions. |
...
| 92 | 󰔄 | U+F0504 | `radial_contained_gradient_extend_mode_repeat` | Tests Paint(Var)RadialGradient (one circle contained within the other) with variable gradient coordinates or variable color lines. | `GRX0`, `GRY0`, `GRX1`, `GRY1`, `GRX2`, `GRY2`, `GRR0`, `GRR1` affect respective gradient coordinates. `COL1`, `COL2`, `COL3` shift color stops. |
...
| 118 | 󰨀 | U+F0A00 | `composite_CLEAR` | Tests `PaintComposite` for mode CLEAR. | None |
...
| 155 | 󰰁 | U+F0C01 | `clip_box_bottom_left` | Tests `(Var)ClipBox`. | `CLXI` shifts ClipBox `x_min`, `CLYI` shifts `y_min`, `CLXA` shifts `x_max`, `CLYA` shifts `y_max`. |
...
| 176 | 󱄀 | U+F1100 | `satellite_waves` | Illustrates a radio wave from a satellite. | `SANI` moves the motion of the satellite radio wave. |
...
namespace ColrV1TestDefinitions {
    ...
    const uint32_t satellite[] = { 0xf1100 };
};
```
